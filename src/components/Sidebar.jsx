...
const menuItems = [
    ...
    { id: "sdo", label: "SDO Grid", icon: BarChart3, route: "/sdo" },
    { id: "lineman", label: "Lineman Grid", icon: CheckCircle, route: "/lineman" },
    { id: "etg", label: "ETG Grid", icon: Shield, route: "/etg" },
    { id: "ces", label: "CES Grid", icon: Building, route: "/ces" },
    { id: "ces-audit", label: "CES Audit", icon: Building, route: "/ces-audit" },
    { id: "report", label: "Reports", icon: Package, route: "/report" },
  ];
